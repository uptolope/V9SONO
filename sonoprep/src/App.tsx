...
function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    const drawOrbs = () => {
      ...
      const mouseOrb = ctx!.createRadialGradient(mouseRef.current.x, mouseRef.current.y, 0, mouseRef.current.x, mouseRef.current.y, 200);
    ...
    const drawWaves = () => {
      for (let w = 0; w < 3; w++) {
        ...
        for (let x = 0; x <= width; x += 3) {
          const dist = Math.sqrt((x - mouseRef.current.x) ** 2 + (mouseRef.current.y - height * 0.5) ** 2);
    ...
    <>
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-700 ${
        ...
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-5">
            <a href="#demo" className="group relative px-5 py-2.5 text-sm font-medium text-[#a8a29e] hover:text-[#e8e4df] transition-all duration-300 overflow-hidden rounded-lg">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="relative pt-28 px-8 flex flex-col gap-6 animate-slide-in-from-top">
            {[
              { name: "Home", href: "/" },
              { name: "Products", href: "#products" },
              { name: "Features", href: "#features" },
              ...
              <a
                ...
                href={link.href}
                onClick={link.href.startsWith("#") ? (e) => { e.preventDefault(); handleAnchor(link.href); } : undefined}
                className="text-3xl font-serif text-[#e8e4df] hover:text-teal-400 transition-colors duration-300 animate-slide-in-from-left"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                {link.name}
              </a>
            ))}
            <div className="pt-8 flex flex-col gap-4 animate-fade-in" style={{ animationDelay: "500ms" }}>
              <a href="#demo" onClick={() => setMobileOpen(false)} className="text-center py-4 border border-white/20 rounded-xl text-[#e8e4df] backdrop-blur bg-white/5">Try Free Demo</a>
              <a href="#dashboard" onClick={() => setMobileOpen(false)} className="text-center py-4 bg-gradient-to-r from-teal-600 to-teal-500 rounded-xl text-white font-medium shadow-[0_0_30px_rgba(20,184,166,0.3)]">Get Started</a>
            </div>
          </div>
        </div>
      )}
      ...
      <div className={`relative z-10 max-w-6xl mx-auto px-8 pt-24 pb-20 transition-all duration-1500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
        ...
        >
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-[#e8e4df] mb-6 leading-[1.1] tracking-tight">
            <span className="block animate-slide-in-from-bottom" style={{ animationDelay: "500ms" }}>Master the</span>
            <span className="block relative mt-2 animate-slide-in-from-bottom" style={{ animationDelay: "700ms" }}>
              <span className="bg-gradient-to-r from-teal-400 via-teal-300 to-amber-400 bg-clip-text text-transparent animate-gradient">
                SPI Exam
              </span>
            </span>
            <span className="block mt-2 animate-slide-in-from-bottom" style={{ animationDelay: "900ms" }}>with Clinical Precision</span>
          </h1>
        </div>

        {/* Subtitle */}
        <p className={`text-lg sm:text-xl text-[#a8a29e] max-w-3xl mx-auto mb-12 leading-relaxed transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ animationDelay: "1100ms" }}>
        ...
        {/* CTA buttons */}
        <div className={`flex flex-col sm:flex-row items-center justify-center gap-5 mb-20 transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ animationDelay: "1300ms" }}>
          <a
            href="#demo"
        ...
        <div className={`grid grid-cols-3 gap-8 max-w-xl mx-auto transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ animationDelay: "1500ms" }}>
          {[
...
function ProductCard({ product, index }: { product: typeof products[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-xl`} style={{ background: `radial-gradient(circle at center, ${product.color}15 0%, transparent 70%)` }} />
      ...
      >
        ...
        {product.highlight && (
          <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 via-transparent to-amber-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700" style={{ backgroundSize: "200% 100%", animation: "gradient-shift 3s ease infinite" }} />
        )}
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          {/* Animated circles */}
          <div
            className="absolute top-1/2 left-1/2 rounded-full border border-white/10 transition-all duration-700"
            style={{
              width: "8rem",
              height: "8rem",
          ...
          />
          <div
            className="absolute top-1/2 left-1/2 rounded-full border border-white/5 transition-all duration-700"
            style={{
              width: "6rem",
              height: "6rem",
    ...
    <section ref={sectionRef.ref} className="relative py-32 sm:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0" style={{
          backgroundImage: "radial-gradient(circle at 20% 30%, rgba(20,184,166,0.2) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(245,158,11,0.15) 0%, transparent 50%)",
        }} />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8 relative z-10">
        ...
        {/* Achievement badges */}
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto transition-all duration-1000 ${sectionRef.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`} style={{ transitionDelay: "600ms" }}>
...
function CTASection() {
  ...
  return (
    <section id="demo" ref={sectionRef.ref} className="relative py-32 sm:py-40 overflow-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          {[
            {
              title: "Products",
              links: ["SPI Flashcards", "Physics Pearls", "Exam Simulator", "Study Notes", "Premium Bundle"].map(name => ({ name, href: "#" }))
            },
            {
              title: "Resources",
              links: [
            ...
            <div key={col.title}>
              ...
              <ul className="space-y-4">
                {col.links.map((l) => (
                  <li key={l.name}>
                    <a href={l.href} className="text-sm text-[#78716c] hover:text-[#e8e4df] transition-colors duration-300 hover:translate-x-1 inline-block">
                      {l.name}
                    </a>
                  </li>
                ))}
      ...
      <style>{`
        ...
        * {
        ...
        .animate-slide-in-from-bottom {
          animation: slide-in-from-bottom 1s cubic-bezier(0.16, 1, 0.3, 1) both;
        }

        .animate-slide-in-from-top {
          animation: slide-in-from-top 0.8s cubic-bezier(0.16, 1, 0.3, 1) both;
        }

        .animate-slide-in-from-left {
          animation: slide-in-from-left 0.8s cubic-bezier(0.16, 1, 0.3, 1) both;
        }
