      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="depth-border corner-arch mb-16">
          <div className="grid md:grid-cols-5 gap-0">
            {/* Photo placeholder – you can replace with actual image later */}
            <div className="md:col-span-2 bg-[#1a212b] flex items-center justify-center min-h-[300px]">
              <div className="text-center p-8">
                <div className="w-32 h-32 mx-auto bg-[#c85b3a]/20 rounded-full flex items-center justify-center mb-4">
            ...
            <div className="md:col-span-3 p-8 md:p-10">
              ...
              <div className="space-y-4 text-[#b8b0a4] text-sm leading-relaxed">
                ...
                <p>The SPI exam is a specific challenge. It tests physics concepts that many programs gloss over, and most study materials treat it like an afterthought. I built SonoPrep because I kept seeing the same gap: students who were excellent clinically but under‑prepared for the way the ARDMS actually tests this content.</p>
                <p>Every flashcard, exam question, and physics pearl in SonoPrep comes from real teaching experience — the mistakes I&apos;ve seen students make, the concepts that trip people up, and the explanations that actually make things click.</p>
