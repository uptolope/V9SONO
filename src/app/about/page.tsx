    ...
    <div className="min-h-screen pt-32 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="display-display text-5xl sm:text-6xl text-white mt-4 mb-4">About SonoPrep</h1>
          <p className="body-readable text-[#c2bab0] max-w-2xl mx-auto">We're sonographers who were frustrated by the lack of quality SPI exam prep. So we built what we wished existed.</p>
        </div>
          ...
          <div className="grid md:grid-cols-5 gap-0">
            <div className="md:col-span-2 bg-[#1a212b] flex items-center justify-center min-h-[300px]">
              <div className="text-center p-8">
                <div className="w-48 h-48 mx-auto rounded-full overflow-hidden border-2 border-[#c85b3a]/40 mb-4">
                  <Image
                    src="/images/olajide-labiyi-founder.jpg"
                    alt="Olajide Labiyi — Founder of SonoPrep"
                    width={192}
                    height={192}
            ...
            <div className="md:col-span-3 p-8 md:p-10">
              ...
              <h2 className="display-serif text-3xl font-semibold text-white mb-1">Olajide Labiyi</h2>
              <p className="text-[#c85b3a] mb-6">RDCS</p>
              <div className="space-y-4 text-[#c2bab0] text-sm leading-relaxed">
                ...
                <p className="text-white">My goal isn't just to help you pass an exam. It's to make sure you walk into your career with the confidence and understanding that sets you apart.</p>
              </div>
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {CREDENTIALS.map((cred) => (
                  <div key={cred} className="flex items-center gap-3 border border-[#c85b3a]/30 bg-[#c85b3a]/5 px-4 py-2.5">
                    ...
                    <span className="text-sm text-white">{cred}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {VALUES.map((val) => (
            <div key={val.title} className="depth-border corner-arch p-6 tactile-card">
              <h3 className="display-serif text-xl font-semibold text-white mb-3">{val.title}</h3>
              <p className="body-small text-[#c2bab0] text-sm">{val.desc}</p>
            </div>
          ))}
        </div>
        <div className="bg-[#c85b3a]/10 p-8 border-l-[3px] border-[#c85b3a] text-center">
          <p className="body-readable text-white text-sm">We're a small, independent team. If you have feedback, reach out. We're always improving.</p>
        </div>
      </div>
    </div>
  );
