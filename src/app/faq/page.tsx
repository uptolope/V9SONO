...
const FAQ_ITEMS = [
  { q: "How many questions are in the full exam simulator?", a: "167 questions in the bank. Each exam session draws 110 questions — the same count as the real SPI — randomized and domain-weighted, so every attempt is unique. You get 3 exam attempts within a 60-day access window." },
  { q: "How long do I have access after purchase?", a: "60 days from the date of purchase. Enough time to complete the recommended 6‑week study plan." },
  ...
  { q: "How many exam attempts do I get?", a: "3 attempts within your 60-day access window. Each attempt draws a fresh set of 110 random questions from the 167 bank, so every exam is different. Once you start an attempt, the 2.5-hour timer begins and cannot be paused — make sure you're ready before clicking Start." },
  { q: "Does the simulator have a timer?", a: "Yes. The full exam simulator includes a 2.5-hour countdown timer, matching the real exam. It auto‑submits when time runs out." },
  ...
  { q: "What happens after 60 days?", a: "Access expires. You can purchase another 60-day access if you need more time." },
