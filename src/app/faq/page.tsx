...
const FAQ_ITEMS = [
  { q: "How many questions are in the full exam simulator?", a: "170 questions – exactly the same number as the real SPI exam. Each attempt is randomized to prevent cheating." },
  ...
  { q: "What is the passing score for the SPI exam?", a: "555 out of 700 (approximately 79%). You need to correctly answer about 134 of the 170 questions." },
  ...
  { q: "Does the simulator have a timer?", a: "Yes. The full exam simulator includes a 3‑hour countdown timer, matching the real exam. It auto‑submits when time runs out." },
        ...
        <div className="space-y-6">
          {FAQ_ITEMS.map((item, idx) => (
            <div key={idx} className="border-l-[3px] border-[#c85b3a] pl-5">
              ...
              <p className="body-readable text-[#b8b0a4] text-sm leading-relaxed">{item.a}</p>
            </div>
          ))}
        </div>
      </div>
