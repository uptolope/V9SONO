...
export const metadata: Metadata = {
  ...
  keywords: ["ARDMS SPI exam blueprint", "SPI content outline", "SPI domain weightings"],
  alternates: {
    ...
    >
      ...
      <div className={proseClasses.callout}>
        <p className="text-white text-sm mb-0">
          <strong>Quick gut check:</strong> if you can't confidently work through aliasing, wall filters, sample gate placement, and spectral Doppler measurements, you have a gap in the single largest domain on the exam — worth fixing before test day, not after.
        </p>
      </div>

      <h2 className={proseClasses.h2}>Domain 1: Perform Ultrasound Examinations (23%)</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>Domain 2: Manage Ultrasound Transducers (7%)</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>Domain 3: Optimize Sonographic Images (26%)</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>Domain 4: Apply Doppler Concepts (34%)</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>Domain 5: Provide Clinical Safety &amp; Quality Assurance (10%)</h2>
      <p>
