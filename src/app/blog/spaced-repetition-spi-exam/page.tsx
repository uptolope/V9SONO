...
export const metadata: Metadata = {
  title: "Spaced Repetition for SPI Exam Success: Why Active Recall Beats Cramming | SonoPrep",
  description:
  ...
  keywords: ["spaced repetition SPI exam", "active recall studying", "SM-2 algorithm flashcards"],
  alternates: {
...
export default function Page() {
  return (
    ...
    >
      ...
      <h2 className={proseClasses.h2}>What "active recall" means, and why it matters</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>How spaced repetition algorithms work, in plain terms</h2>
      <p>
      ...
      <ul className={proseClasses.ul}>
        <li>Each card has an "interval" — how many days until it's shown again.</li>
        <li>Each time you review a card, you rate how well you recalled it (typically on a scale from "again" / failed, to "easy").</li>
        <li>If you recalled it easily, the interval increases — sometimes substantially, since the algorithm wants to space out cards you know well.</li>
        <li>If you struggled or got it wrong, the interval resets to something short, so you see the card again soon.</li>
        <li>Over time, cards you consistently know well drift toward longer and longer intervals (weeks, then months), while cards you struggle with stay in frequent rotation until they "graduate."</li>
      </ul>
      <p>
      ...
      <h2 className={proseClasses.h2}>Why this matters more for the SPI than for some other exams</h2>
      <p>
      ...
      <h2 className={proseClasses.h2}>Practical tips for using a spaced repetition system for SPI prep</h2>
      <ul className={proseClasses.ul}>
        <li><strong className="text-white">Be honest with your self-ratings.</strong> If you got a card right but had to think hard or got lucky on a guess, rate it as a struggle, not a success. Inflated ratings push cards into long intervals before you've actually mastered them.</li>
        <li><strong className="text-white">Do your reviews daily, even briefly.</strong> The algorithm's scheduling assumes consistent daily engagement. Skipping several days causes a backlog of overdue cards, which can make a session feel overwhelming and discourage consistency further.</li>
        <li><strong className="text-white">Don't over-create new cards early on.</strong> Adding too many new cards per day creates a growing review backlog within a couple of weeks. A steady, moderate pace of new material is more sustainable than front-loading everything in week one.</li>
        <li><strong className="text-white">Pair flashcards with practice questions and a full simulator.</strong> Flashcards build the underlying knowledge; full-length practice exams build the application and pacing skills covered in our test-taking strategies guide. Neither replaces the other.</li>
      </ul>
