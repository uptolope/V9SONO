// Server component — metadata exports correctly for SEO crawlers
...
export const metadata: Metadata = {
  ...
  description:
    "Pass the ARDMS SPI exam required for RDMS, RDCS, RVT, and RMSKS credentials. 200+ flashcards, 110-question simulator, and Physics Pearls built by RDMS-credentialed sonographers. From $9.",
  keywords: [
    "SPI exam prep",
    "ARDMS SPI",
