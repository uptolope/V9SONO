...
export const metadata: Metadata = {
  ...
  description: "Pass the ARDMS SPI exam with flashcards, simulator, and physics pearls. Built by sonographers who passed.",
  icons: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="bg-[#0a0c10]">{children}</body>
    </html>
  );
}
