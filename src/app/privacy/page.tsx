    ...
    <div className="min-h-screen pt-32 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-[#c2bab0] body-readable leading-relaxed">
          ...
          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">2. What Data We Collect</h2>
            <p className="mb-3">We collect only what is necessary to provide the service:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong className="text-white">Account data:</strong> email address and password (hashed) when you register.</li>
              ...
              <li><strong className="text-white">Usage data:</strong> flashcard progress, exam scores, and session activity — used to power your study dashboard.</li>
              <li><strong className="text-white">Analytics data:</strong> page views and session duration via Google Analytics (anonymized IP). You can opt out via browser extensions that block GA.</li>
              <li><strong className="text-white">Support data:</strong> any information you send us by email.</li>
            </ul>
          </section>

          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">3. How We Use Your Data</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">4. Third-Party Services</h2>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong className="text-white">Supabase</strong> — database. Data is stored in the US. Subject to <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#c85b3a] hover:underline">Supabase's Privacy Policy</a>.</li>
            </ul>
          </section>

          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">5. Data Retention</h2>
            <p>
              We retain your account data for as long as your account is active. If you delete your account, we delete your personal data within 30 days, except where we are required to retain it by law (e.g., payment records for tax purposes, retained for 7 years).
            </p>
          </section>

          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">6. Your Rights</h2>
          ...
          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">7. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">8. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">9. Changes to This Policy</h2>
            <p>
              We may update this policy. When we do, we will update the "Last updated" date at the top of this page. Continued use of the service after changes constitutes acceptance of the updated policy.
            </p>
          </section>

          <section>
            <h2 className="display-serif text-xl font-semibold text-white mb-3">10. Contact</h2>
            <p>
