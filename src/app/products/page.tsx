...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tag: "TEST YOURSELF",
    description:
      "3 exam attempts over 90 days. Each draws 110 random questions from a 170+ bank — ARDMS domain-weighted, 2-hour timer, with detailed rationales. Per-domain analytics show exactly where you're losing points.",
    features: [
...
export default function ProductsPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen pt-32 px-6 text-[#3a3530] text-sm">
        Loading…
      </div>
    );
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-14 border-b border-white/6 pb-10">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                },
                {
                  ...
                  is: "110 questions drawn from 170+ bank, mapped to 6 domains at real exam ratios",
                },
                {
                  not: "Not a subscription",
                  is: "One payment. 90-day access. 14-day full refund policy.",
                },
              ].map(({ not, is }) => (
                <div key={not}>
          ...
          <p className="meta text-[9px] text-[#3a3530] mt-4">
            All products include 90-day access · 14-day full refund policy ·
