...
export default function BlogPostLayout({
  tag, title, date, read, url, description, children,
}: BlogPostLayoutProps) {
    ...
    <>
      ...
      <div className="min-h-screen pt-32 px-6">
        <div className="max-w-3xl mx-auto">
          <Link href="/blog" className="meta text-[11px] text-[#8a8279] hover:text-[#c85b3a] mb-8 inline-block">
            ← BACK TO BLOG
          </Link>
          ...
          <div className="mb-12">
            ...
            <h1 className="display-display text-3xl sm:text-5xl text-white mt-2 mb-4 leading-tight">{title}</h1>
          ...
          <div className="mt-16 flex gap-6 text-sm text-[#8a8279] meta border-t border-white/8 pt-8">
            <Link href="/blog" className="hover:text-[#c85b3a]">All Articles</Link>
            <Link href="/terms" className="hover:text-[#c85b3a]">Terms</Link>
            <Link href="/privacy" className="hover:text-[#c85b3a]">Privacy</Link>
          </div>
        </div>
      </div>
    </>
