...
async function main() {
  ...
  for (const product of PRODUCTS) {
    ...
    console.log(`  ✓ ${result.name} (${result.type}) — $${(result.priceInCents / 100).toFixed(2)}`);
  }
