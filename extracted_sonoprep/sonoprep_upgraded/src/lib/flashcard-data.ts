 ...
 *
 * These are the 10 demo flashcards from the existing SonoPrep platform.
 * The full 200-card deck is loaded from the database for paying users.
 */
export const DEMO_FLASHCARDS: Flashcard[] = [
  ...
  },
  {
    id: 2,
    front:
      "What is the typical frequency range for a curved array transducer used for abdominal imaging?",
